...
public partial class MainWindow : Window
{
    ...
    private void OnWebMessageReceived(object? sender, CoreWebView2WebMessageReceivedEventArgs e)
    {
        ...
        switch (message.Type)
        {
            ...
            case "restore-original":
                ...
                break;
            case "launch-game":
                _ = _gameRunning ? CloseGameAsync() : LaunchGameAsync();
                break;
            ...
            case "save-applechu-config":
                SaveAppleChuConfig(message.Payload);
                break;
            case "check-update":
    ...
    private void SaveAppleChuConfig(JsonElement payload)
    {
        if (string.IsNullOrWhiteSpace(_startBatPath) ||
        ...
        try
        {
            ...
            content = SetTomlValue(content, "BypassAppUser", "enable", "true");
    ...
    {
        var process = _gameCommandProcess;
        if (process is null)
        {
            SetGameRunningState(false);
            return;
        ...
        try
        {
            ...
            {
                await WaitForCommandProcessExitAsync(killer);
            }
        }
        catch
        {
            SetStatus("关闭游戏失败", "#ff5a6a");
        }
    }
    ...
    private void SetGameRunningState(bool running)
    {
        ...
        PostMessage("game-state", new { running });
    }
